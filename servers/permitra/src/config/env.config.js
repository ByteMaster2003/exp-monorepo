...
const AppConfig = {
  ...
  AUTH: {
    ...
    PERMITRA_BASE_URI: Vars.PERMITRA_BASE_URI,
    PERMITRA_ERR_URI: Vars.PERMITRA_ERR_URI,
    CONTROL_DECK_AUTH_URI: Vars.CONTROL_DECK_AUTH_URI,
    RESTIFY_AUTH_URI: Vars.RESTIFY_AUTH_URI
  },
  REDIS: {
    URL: Vars.REDIS_URL,
  ...
  GOOGLE: {
    ...
    SECRET_KEY: Vars.GOOGLE_SECRET_KEY
  },
  GITHUB: {
    CLIENT_ID: Vars.GITHUB_CLIENT_ID,
    SECRET_KEY: Vars.GITHUB_SECRET_KEY
  }
};
